...
static struct vreg_config vreg_conf[] = {
	{ "vdd_spi", 1200000UL, 1200000UL, 6000, FPC_GPIO_NO_DEFAULT,},
	{ "vdd_io", 1800000UL, 1800000UL, 6000, FPC_GPIO_NO_DEFAULT,},
#ifdef FPC_3V
	{ "vdd_ana", 2800000UL, 2800000UL, 6000, FPC_GPIO_NO_DEFAULT,},
#endif
